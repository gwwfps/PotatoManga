...
//    val arrayAdapter = ArrayAdapter<String>(getActionBar().getThemedContext() as Context,
//        R.layout.simple_list_item_activated_1,
//        R.id.text1,
//        array<String>(
//            getString(string.title_section1),
//            getString(string.title_section2),
//            getString(string.title_section3)))
//    mDrawerListView!!.setAdapter(arrayAdapter)
  ...
  override fun onOptionsItemSelected(item: MenuItem?): Boolean {
    ...
    if (item!!.getItemId() == R.id.action_example) {
      Toast.makeText(getActivity() as Context, "Example action.", Toast.LENGTH_SHORT).show()
      return true
    }
